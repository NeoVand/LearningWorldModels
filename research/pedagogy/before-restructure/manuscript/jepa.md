...
A Gaussian-looking two-dimensional projection does not establish joint Gaussianity, and joint Gaussianity would still not establish useful causal structure. The diagnostic chain must extend from geometry through prediction to action.
