...
<div class="camera-inspection-controls"><button id="world-camera-inspect" type="button" aria-haspopup="dialog" aria-controls="world-camera-dialog" aria-describedby="world-camera-inspect-note">Inspect camera pixels</button><p id="world-camera-inspect-note" class="lab-note">Magnification shows the same 64 × 64 sensor pixels; it adds no image detail. The forecast below is a pose drawing, not a camera frame.</p></div>
<div id="world-camera-pair" class="sensor-pair"><div><canvas id="world-current" width="64" height="64" aria-label="Actual camera image supplied to the model" aria-describedby="world-current-provenance"></canvas><div class="plot-label">Current camera · 64 × 64</div><div id="world-current-provenance" class="camera-provenance">Simulator preview · no model prepared</div></div><div><canvas id="world-goal-image" width="64" height="64" aria-label="Goal camera image" aria-describedby="world-goal-provenance"></canvas><div class="plot-label">Goal camera · 64 × 64</div><div id="world-goal-provenance" class="camera-provenance">Simulated goal reference · not a forecast</div></div></div>
<dialog id="world-camera-dialog" aria-labelledby="world-camera-dialog-title" aria-describedby="world-camera-dialog-note"><div class="camera-dialog-head"><div><h4 id="world-camera-dialog-title">Inspect camera pixels</h4><p id="world-camera-dialog-note">The same sensor pixels, enlarged for inspection.</p></div><button id="world-camera-dialog-close" type="button">Close</button></div><div id="world-camera-dialog-frames" class="camera-dialog-frames"></div></dialog>
<div class="control-comparison"><svg id="world-control-plot" class="control-instrument" viewBox="0 0 720 360" role="img" aria-label="Actual arm, goal arm, and imagined future poses"></svg><div class="control-trace"><h4>Physical goal error</h4><svg id="world-goal-trace" viewBox="0 0 320 180" role="img" aria-label="Physical goal-error trace"></svg><p id="world-goal-trace-summary" class="lab-note">Action 0 will be measured from the simulator.</p></div></div>
