...
<figure class="generated-plate" data-art="H3"><img src="assets/generated/infographics/lineage-corrected-1.png" alt="Five research methods compared by the prediction targets they use."/><figcaption>These methods differ in their data, prediction targets, gradient paths and evaluation. The scenes identify the task; the comparison table supplies the training details. Proximity on this plate does not imply a direct research dependency.</figcaption></figure>
